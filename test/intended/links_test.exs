defmodule Intended.LinksTest do
  use Intended.DataCase
  ...
  describe "links" do
    ...
    @valid_attrs %{expires: ~N[2010-04-17 14:00:00]}
    @update_attrs %{expires: ~N[2011-05-18 15:01:01]}
    @invalid_attrs %{expires: nil}
    ...
    test "create_link/1 with valid data creates a link" do
      ...
      assert link.expires == ~N[2010-04-17 14:00:00]
    end
    ...
    test "update_link/2 with valid data updates the link" do
      ...
      assert link.expires == ~N[2011-05-18 15:01:01]
    end
